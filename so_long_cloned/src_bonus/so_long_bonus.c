...
/*   Updated: 2023/06/01 20:07:11 by Jroldan-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_so_long(t_so_long *c)
{
	...
	c->t_open = mlx_load_png("img/closed.png");
	c->t_enemy = mlx_load_png("img/enemy.png");
	...
	c->enemy = mlx_texture_to_image(c->mlx, c->t_enemy);
}
